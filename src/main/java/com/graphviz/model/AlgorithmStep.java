 ...
 *
 * Both Kruskal's MST and Bellman-Ford produce an ordered list of steps that the
 * controller plays back. Every step is tied to one edge — the edge that the
 * algorithm is looking at during that step — which the controller highlights.
 *
 ...
 * improve?), the controller checks the concrete step type (MstStep or
 * BellmanFordStep).
 *
